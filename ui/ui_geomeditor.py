...
#
# Created: Wed Mar  6 14:13:33 2013
...
class Ui_GeomEditor(object):
    def setupUi(self, GeomEditor):
        ...
        self.widget = QtGui.QWidget(self.sketchBox)
        ...
        self.rubber_color = QtGui.QToolButton(self.widget)
        self.rubber_color.setToolTip(_fromUtf8(""))
        self.rubber_color.setWhatsThis(_fromUtf8(""))
        self.rubber_color.setText(_fromUtf8(""))
        self.rubber_color.setObjectName(_fromUtf8("rubber_color"))
        self.gridLayout_5.addWidget(self.rubber_color, 0, 2, 1, 1)
        ...
        QtCore.QObject.connect(self.sketchBox, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.widget.setEnabled)
    ...
    def retranslateUi(self, GeomEditor):
        ...
        self.checkBox.setText(QtGui.QApplication.translate("GeomEditor", "sketch point under mouse", None, QtGui.QApplication.UnicodeUTF8))
