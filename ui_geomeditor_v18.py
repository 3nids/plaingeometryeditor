...
#
# Created: Wed Mar  6 14:13:34 2013
...
class Ui_GeomEditor(object):
    def setupUi(self, GeomEditor):
        ...
        self.rubberSettingsFrame = QtGui.QFrame(GeomEditor)
        self.rubberSettingsFrame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.rubberSettingsFrame.setMidLineWidth(0)
        ...
        self.label_2 = QtGui.QLabel(self.rubberSettingsFrame)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.gridLayout_5.addWidget(self.label_2, 0, 0, 1, 1)
        self.toolButton_3 = QtGui.QToolButton(self.rubberSettingsFrame)
        ...
        self.gridLayout_4.addWidget(self.geomTextEdit, 1, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.w5, 5, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.w2, 2, 0, 1, 2)
        ...
        self.toolButton = QtGui.QToolButton(self.w3)
        self.toolButton.setCheckable(True)
        self.toolButton.setChecked(False)
        self.toolButton.setObjectName(_fromUtf8("toolButton"))
        self.gridLayout.addWidget(self.toolButton, 0, 0, 1, 1)
        self.sketchBox = QtGui.QCheckBox(self.w3)
        self.sketchBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.sketchBox.setChecked(True)
        self.sketchBox.setObjectName(_fromUtf8("sketchBox"))
        self.gridLayout.addWidget(self.sketchBox, 0, 1, 1, 1)
        spacerItem3 = QtGui.QSpacerItem(255, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem3, 0, 2, 1, 1)
        self.gridLayout_4.addWidget(self.w3, 3, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.w0, 0, 0, 1, 2)

        self.retranslateUi(GeomEditor)
        QtCore.QObject.connect(self.sketchBox, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.toolButton.setEnabled)
        QtCore.QObject.connect(self.toolButton, QtCore.SIGNAL(_fromUtf8("clicked(bool)")), self.rubberSettingsFrame.setVisible)
        QtCore.QObject.connect(self.sketchBox, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.rubberSettingsFrame.setEnabled)
    ...
    def retranslateUi(self, GeomEditor):
        ...
        self.toolButton.setText(QtGui.QApplication.translate("GeomEditor", ">", None, QtGui.QApplication.UnicodeUTF8))
